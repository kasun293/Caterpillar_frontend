...
import 'package:caterpillar/screens/signin_page.dart';
...
class _ButterflyScreenState extends State<ButterflyScreen> {
  Map<String, dynamic> butterflyDetails = {};
  Map<String, String> convertedButterflyDetails = {};
  ...
  Future<void> _fetchAndSetData() async {
    ...
    try {
      ...
      setState(() {
        ...
        // butterflyDetails = response['butterfly_info'];
        convertedButterflyDetails = butterflyDetails
      ...
      appBar: AppBar(
        ...
        actions: [
          TextButton(
            ...
            child: Text('logout',
                style: TextStyle(color: Color.fromARGB(255, 92, 17, 17))),
          ),
        ],
      ),
      body: Container(
